        ...
        <div class="container-fluid">
            ...
            <main id="main" class="main">
                ...
                <div class="pagetitle">
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index">Team</a></li>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-body pt-3">
                            ...
                            <form action="{{ route('team-update', $data->team_id) }}" method="POST"
                                ...
                                <div class="form-group mt-4">
                                    ...
                                    <textarea name="profession" id="profession" class="form-control">{{ $data->profession }}</textarea>
                                </div>
