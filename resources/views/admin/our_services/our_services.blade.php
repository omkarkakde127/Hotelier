                                ...
                                <div class="card-body pt-3">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 text-end">
                                            <a href="{{ route('our_services-add') }}" class="btn btn-primary">Add</a>
                                        </div>
                                    </div>
     ...
     <script>
        document.addEventListener("DOMContentLoaded", function () {
            let table = new DataTable('#example', {
                processing: true,
                serverSide: true,
                ajax: "{{ route('our_services_script') }}", // Ensure this route returns JSON data
                columns: [
                    { data: 'our_services_id', name: 'our_services_id' },
                    {
                        data: 'title', // Using 'fullName' directly from the controller
                        name: 'title'
                    },
                    {
                        data: 'description',
                    ...
                    {
                        data: 'image', // Action column, populated by controller
                        name: 'image'
                    },
                    { 
                        data: 'action', 
