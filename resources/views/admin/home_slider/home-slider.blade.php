        ...
        <div class="container-fluid">
            <main id="main" class="main">
                ...
                <div class="pagetitle">
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Home_Slider</li>
                        </ol>
                    </nav>
                </div><!-- End Page Title -->
                <section class="section">
                                ...
                                <div class="card-body pt-3">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 text-end">
                                            <a href="{{ route('homeslider-add') }}" class="btn btn-primary">Add</a>
                                        </div>
                                    </div>
                    ...
                    <script>
                       function confirmDelete(home_slider_id) {
                            Swal.fire({
                                title: "Are you sure?",
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    document.getElementById('delete-form-' + home_slider_id).submit();
                                }
                            });
                        }
                    </script>
     ...
     <script>
        document.addEventListener("DOMContentLoaded", function () {
            let table = new DataTable('#example', {
                processing: true,
                serverSide: true,
                ajax: "{{ route('home_slider_script') }}", // Ensure this route returns JSON data
                columns: [
                    { data: 'home_slider_id', name: 'home_slider_id' },
